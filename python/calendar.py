#PARTE I -  Recebimento da data atual
...
mesAtual = hoje.month
diaAtual = hoje.day
diaSemAtual = date.today().weekday()
...
#print (type(diaAtual))
print (diaSemAtual)
#print (type(diaSemAtual))

#Teste Automatizado

#PARTE II - Verificação do ano de Kali Yuga corrente

kaliYuhaInicioAno = 3102
kaliYugaInicioMes = 1
kaliYugaInicioDia = 23
anoKaliYuga = 0

mesAtual = randint(1,12)
diaAtual = randint(1,31)
